...
class Ui_Picture_tab2(object):
    def setupUi(self, Picture_tab):
        ...
        self.image_label = QLabel(self.second_tab)
        self.image_label.setObjectName(u"image_label")
        self.image_label.setGeometry(QRect(10, 10, 551, 16))
        ...
        self.second_tab_2.setCurrentIndex(1)
        

        tab_remove = self.second_tab_2
        tab_remove.tabCloseRequested.connect(lambda index: tab_remove.removeTab(index))
    ...
    def retranslateUi(self, Picture_tab):
        ...
        self.image_label.setText(QCoreApplication.translate("Picture_tab", u"                                                                        HAPPY  FAMILY", None))
...
class pictures2(QMainWindow, Ui_Picture_tab2):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
